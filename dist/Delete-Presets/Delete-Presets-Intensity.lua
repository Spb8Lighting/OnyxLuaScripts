-- ShowCockpit LUA Script: DeleteRangeOfIntensityPreset
...
-- Purpose --
-------------
-- This script allows to delete a range of Intensity presets (batch mode)
...
ScriptInfos = {
    version = "1.0",
    name = "DeleteRangeOfIntensityPreset"
}
